    ...
    releaseNotes: {
      ...
      versions: {
        v1_8_4: {
          ...
          greeting: "Hi there,",
          subtitle: "Live Match Timeline, Game Momentum & Prediction Leaderboard",
          date: "June 2026",
          badge: "Current",
          features: {
            predictionLeaderboardTitle: "Global Prediction Leaderboard",
            predictionLeaderboardDesc: "Compete with other users! Cast your vote on match outcomes before kickoff and earn points. See where you stand on the new dynamic glassmorphic leaderboard in the World Cup Hub.",
    ...
    releaseNotes: {
      ...
      versions: {
        v1_8_4: {
          ...
          greeting: "Bonjour,",
          subtitle: "Fil du Match, Pression de Jeu & Classement des Pronostics",
          date: "Juin 2026",
          badge: "Actuelle",
          features: {
            predictionLeaderboardTitle: "Classement Mondial des Pronostics",
            predictionLeaderboardDesc: "Affrontez les autres utilisateurs ! Votez pour l'issue des matchs avant le coup d'envoi et gagnez des points. Découvrez votre position sur le nouveau classement dynamique en 'glassmorphism' dans le Hub Coupe du Monde.",
